...
export const getKonuStarterCardTemplate = (
  ...
  const defaultButtons: CardButton[] = [
    {
      id: `btn_edit_${d}_1`,
      title: lang === 'de' ? 'Klicke zum Bearbeiten' : 'Tap to edit',
      actionType: 'none',
      actionValue: '',
      icon: 'Edit',
      iconId: 'Edit',
    ...
    {
      id: `btn_tel_${d}_2`,
      title: lang === 'de' ? 'Telefon hinzufügen' : 'Add phone',
      actionType: 'none',
      actionValue: '',
      icon: 'Phone',
      iconId: 'Phone',
    ...
    {
      id: `btn_mail_${d}_3`,
      title: lang === 'de' ? 'E-Mail hinzufügen' : 'Add email',
      actionType: 'none',
      actionValue: '',
      icon: 'Mail',
      iconId: 'Mail',
    ...
    {
      id: `btn_web_${d}_4`,
      title: lang === 'de' ? 'Website hinzufügen' : 'Add website',
      actionType: 'none',
      actionValue: '',
      icon: 'Globe',
      iconId: 'Globe',
    ...
    {
      id: `btn_wa_${d}_5`,
      title: lang === 'de' ? 'WhatsApp hinzufügen' : 'Add WhatsApp',
      actionType: 'none',
      actionValue: '',
      icon: 'MessageCircle',
      iconId: 'MessageCircle',
      iconColor: '#A855F7',
      backgroundColor: '#F5EFE3',
      bgColor: '#F5EFE3',
      textColor: '#1A1A1A',
    ...
    {
      id: `btn_pdf_${d}_6`,
      title: lang === 'de' ? 'Datei hinzufügen' : 'Add file',
      actionType: 'none',
      actionValue: '',
      icon: 'FileText',
      iconId: 'FileText',
  ...
  return {
    ...
    heroSubtitle: lang === 'de' ? 'Zum Bearbeiten hier klicken' : 'Tap here to edit',
    heroDescription: lang === 'de' ? 'Passe Profil, Hintergrund und Buttons an.' : 'Customize your profile, background and buttons.',
    heroCompany: '',
    heroLocation: '',
    heroTextColor: 'cream',
