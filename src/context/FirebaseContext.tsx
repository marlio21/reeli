...
export const getKonuStarterCardTemplate = (
  ...
  const defaultButtons: CardButton[] = [
    starterButton('phone', lang === 'de' ? 'Telefon' : 'Phone', 'phone', 'Phone', 0),
    starterButton('website', lang === 'de' ? 'Webseite' : 'Website', 'url', 'Globe', 1),
    starterButton('mail', lang === 'de' ? 'Mail' : 'Mail', 'email', 'Mail', 2),
    starterButton('folder', lang === 'de' ? 'Folder' : 'Folder', 'folder', 'FolderOpen', 3),
    starterButton('company', lang === 'de' ? 'Unternehmen' : 'Company', 'contact_form', 'Building2', 4),
    starterButton('file', lang === 'de' ? 'Datei' : 'File', 'pdf_link', 'FileText', 5),
  ];

  return {
    title: lang === 'de' ? 'Deine neue ureel-Seite' : 'Your new ureel page',
    subtitle: lang === 'de' ? 'Aus Video wird Aktion.' : 'Turn video into action.',
    description: lang === 'de' ? 'Telefon, Webseite, Mail, Folder, Unternehmen und Datei sind vorbereitet.' : 'Phone, website, mail, folder, company and file are prepared.',
    profileImageUrl: '',
    ...
    heroDescription: lang === 'de' ? 'Telefon, Webseite, Mail, Folder, Unternehmen und Datei sind vorbereitet.' : 'Phone, website, mail, folder, company and file are prepared.',
    heroCompany: '',
    heroLocation: '',
    heroTextColor: 'cream',
