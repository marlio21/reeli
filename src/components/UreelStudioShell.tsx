          ...
          return (
            <section className="ureel-tap-panel ureel-tap-panel--button">
              ...
              {tapButtonTool === 'look' && <div className="ureel-tap-config ureel-mobile-look-editor">
                ...
                <p className="ureel-tap-inline-hint">Klein 56px, Normal 68px, Groß 112px, Sehr groß 128px. Diese Werte werden direkt in alle Public-Layoutfelder geschrieben.</p>
