          ...
          return (
            <section className="ureel-tap-panel ureel-tap-panel--button">
              ...
              {tapButtonTool === 'look' && <div className="ureel-tap-config ureel-mobile-look-editor">
                ...
                <button type="button" className="ureel-mobile-look-all-button ureel-look-transfer-action" onClick={transferButtonDesignToAll}><LucideIcons.Paintbrush size={16}/><span><b>Look auf alle Buttons übertragen</b><small>Übernimmt Größe, Farbe, Rahmen, Transparenz, Bild, Schrift- und Icon-Look. Text, Aktion und Icon bleiben erhalten.</small></span></button>
              </div>}
